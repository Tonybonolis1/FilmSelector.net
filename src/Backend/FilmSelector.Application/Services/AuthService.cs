...
public class AuthService : IAuthService
{
    ...
    {
        var jwtKey = _configuration["Jwt:Key"] ?? "MySecretKeyForJWT2024FilmSelector123456";
        var jwtIssuer = _configuration["Jwt:Issuer"] ?? "FilmSelectorApi";
        var jwtAudience = _configuration["Jwt:Audience"] ?? "FilmSelectorClient";
