...
using FilmSelector.Api.Middleware;
using FilmSelector.Application.Interfaces;
using FilmSelector.Application.Services;
using FilmSelector.Infrastructure.Extensions;
...
var jwtKey = builder.Configuration["Jwt:Key"] ?? "MySecretKeyForJWT2024FilmSelector123456";
var jwtIssuer = builder.Configuration["Jwt:Issuer"] ?? "FilmSelectorApi";
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "FilmSelectorClient";
