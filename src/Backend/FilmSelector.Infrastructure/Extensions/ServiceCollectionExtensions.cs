...
using FilmSelector.Infrastructure.Clients;
using FilmSelector.Infrastructure.Configuration;
using FilmSelector.Infrastructure.Data;
using FilmSelector.Infrastructure.Repositories;
...
namespace FilmSelector.Infrastructure.Extensions;
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<ApplicationDbContext>(options =>
            options.UseSqlServer(
                ...
                b => b.MigrationsAssembly("FilmSelector.Infrastructure")));
